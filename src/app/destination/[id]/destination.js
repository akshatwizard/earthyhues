                  ...
                  <div className="destination-details__card-content">
                    ...
                    <p
                      ...
                      dangerouslySetInnerHTML={{
                        __html: data.destination?.[0]?.destination_content,
                      }}
                    >
                      {}
                    </p>
                ...
                <div className="col-lg-12">
                  <div className="row">
                    <h1 className="pageHeading animated fadeInUp">
                      Explore {data.destination?.[0]?.destination_name} : Nature
                      Travel Experience by EarthyHues.
                    </h1>
                    {data.location?.map((location) => (
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            <img
                              src={location.location_img_small}
                              alt={`${location.location_name} ${data.destination?.[0]?.destination_name}`}
                          ...
                          <div className="tour-listing__card-content p-4">
                            ...
                            <p
                              ...
                              dangerouslySetInnerHTML={{
                                __html: location.location_details.substring(
                                  0,
                                  250
                                ),
                              }}
                            ...
                            >
                              <span onClick={() => openModal(location)}>
                                Read more
                              </span>
                            </p>
                          </div>
                  ...
                  >
                    {selectedLocation && (
                      <>
                        ...
                        <p
                          dangerouslySetInnerHTML={{
                            __html: selectedLocation.location_details,
                          }}
                        ></p>
                        <div
              ...
              <div className="col-xl-4 col-lg-5">
                  ...
                  <div className="destImageContainer">
                    ...
                    >
                      <div className="carousel-inner">
                        {data.destination[0].destination_image.map(
                          (image, index) => (
                            <div
                              key={index}
                ...
                <aside className="destination-sidebar">
                  <div className="destination-sidebar__tour destination-sidebar__single">
                    <h3 className="destination-sidebar__tour-top-title">
                      Packages
                    </h3>
                    <div className="destination-sidebar__tour-box">
                      {data.packages?.map((packageItem) => (
                        <div
                          ...
                          className="destination-sidebar__tour-item"
                        >
